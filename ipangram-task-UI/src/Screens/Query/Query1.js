...
const Query1 = () => {
  ...
  const getAllEmpData = (e) => {
    ...
    axios
      .post(getEmpLocDeptAPI, newObj, { headers })
      .then((res) => {
  ...
  return (
    <div className="container">
      ...
      <TitleLabel titleLabel={"Query 1"} />
      <p>
        Make a query that retrieves an employee/s who are in IT department and
        location name is starting from A (location may be aurangabad, ahmedabad,
        etc).
      </p>
      <form onSubmit={getAllEmpData}>
        <div className="row mt-3">
          ...
          <div className="col-md-4">
            <strong>Location Initial:</strong>
            <TextField
              id="outlined-basic"
              placeholder="Enter Location initial to search"
              variant="outlined"
              required
              fullWidth
              margin="dense"
